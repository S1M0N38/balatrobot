...
function utils.get_game_state()
  ...
  if G.GAME then
    game = {
      ...
      won = G.GAME.won,
      win_ante = G.GAME.win_ante,
      round_resets = {
        hands = G.GAME.round_resets.hands,
        discards = G.GAME.round_resets.discards,
        reroll_cost = G.GAME.round_resets.reroll_cost,
        temp_reroll_cost = G.GAME.round_resets.temp_reroll_cost,
        temp_handsize = G.GAME.round_resets.temp_handsize,
        ante = G.GAME.round_resets.ante,
        blind_ante = G.GAME.round_resets.blind_ante,
        blind_states = G.GAME.round_resets.blind_states,
        loc_blind_states = G.GAME.round_resets.loc_blind_states,
        blind_choices = G.GAME.round_resets.blind_choices,
        boss_rerolled = G.GAME.round_resets.boss_rerolled,
      },
      hands = G.GAME.hands,
      current_round = {
